...
export const users = pgTable("users", {
  ...
  dailyInputTokensUsed: integer("daily_input_tokens_used").default(0),
  dailyOutputTokensUsed: integer("daily_output_tokens_used").default(0),
  dailyInputTokensLimit: integer("daily_input_tokens_limit"),
