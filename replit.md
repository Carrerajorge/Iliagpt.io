...
The frontend ToolInvocationCard supports live streaming output, elapsed time counters, syntax-highlighted terminal output, clickable URLs, copy-to-clipboard, and rich output rendering. The AgentRunTimeline component shows real-time DAG visualization of cerebro execution with status indicators, critic evaluations, judge verdicts, evidence panels with clickable citations, and run statistics (tokens, cost, duration).
