...
export const securityHeaders = (req: Request, res: Response, next: NextFunction) => {
  ...
  // Allow same-origin iframing for /openclaw-ui (embedded in IliaGPT's /openclaw page)
  const isOpenClawUi = req.path.startsWith("/openclaw-ui");
  res.setHeader("X-Frame-Options", isOpenClawUi ? "SAMEORIGIN" : "DENY");
