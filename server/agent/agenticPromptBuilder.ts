...
const INTENT_INSTRUCTIONS: Record<string, { es: string; en: string }> = {
  ...
  diagram:               { es: "Genera codigo Mermaid en bloque ```mermaid. Usa el tipo mas apropiado: graph TD, sequenceDiagram, classDiagram, stateDiagram-v2, erDiagram, gantt, pie.", en: "Generate Mermaid code inside ```mermaid blocks. Use the most appropriate type: graph TD, sequenceDiagram, classDiagram, stateDiagram-v2, erDiagram, gantt, pie." },
